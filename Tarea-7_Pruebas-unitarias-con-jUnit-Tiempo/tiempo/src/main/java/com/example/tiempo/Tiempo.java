...
public class Tiempo {
	...
	public void setHoras(int horas) throws CantidadNegativaException {
		if (horas < 0)
	...
	public void setMinutos(int minutos) throws CantidadNegativaException {
		if (minutos < 0)
	...
	public void setSegundos(int segundos) throws CantidadNegativaException {
		if (segundos < 0)
